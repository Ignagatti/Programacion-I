...
class Restaurante:
    def __init__(self, ventana, tipo):
        ...
        #esta parte iria dentro de la funcion de reservar, dentro de los botones
        Button(self.parte_inferior, text="Reservar", width=16, font=("Arial", 12), command=lambda: self.reserva(ventana)).grid(row=2, column=0, columnspan=2, padx=35, pady=5)

        Button(self.parte_inferior, text="Cerrar Sesion", width=16, font=("Arial", 12), command=lambda: self.cerrar_sesion(ventana)).grid(row=8, column=0, columnspan=4, padx=25, pady=5)
...
class Reservar_mesa:
    def __init__(self, ventana, tipo):
        ...
        Label(self.parte_inferior, text="Cantidad de Personas:", font=("Arial", 16), bg=fondo).grid(row=1, column=0, pady=10, sticky="e")
        self.entry_personas = Entry(self.parte_inferior, bd=0, width=14, font=("Arial", 16))
        self.entry_personas.grid(row=1, column=1, columnspan=3, padx=5, sticky="w")
